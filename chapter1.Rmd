...
# Belo is the R console, where you will see output
...
*** =instructions
- Execute the lines that define the objects `hello` and `ans` and print their values
- Assign you name or nickname to `my_name`
- Assign the text "you are awsome!" to `my_message`
