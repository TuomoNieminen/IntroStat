...
I say *base* R because there are many additional libraries to R that include methods for analysis, plottig, data collection... We will get to libraries later.  
