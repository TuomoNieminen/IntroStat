...
*** =instructions
- Create a histogram of the life expectancies in the USA states.
...
# Draw a histogram of Life_Exp in US. Make it a colored one!
...
The whiskers extending from the box can be computed by several techniques. The default in R is to extend them to reach to a data point value that is no more than 1.5*IQR away from the box, where IQR is the inter quartile range defined as  
